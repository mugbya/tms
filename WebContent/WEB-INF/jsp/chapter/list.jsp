...
*/
		...
		if (node.attributes.nodeType == 2) {
			...
			if (window.confirm("确认删除该课程及其子项吗？")) {
				window.location.href = "chapter_delete.action?id=" + chapterId;
			}			
		}
		...
		if (node.attributes.nodeType == 3) {
			var sectionId = node.attributes.nodeid;
			window.location.href = "section_delete.action?id=" + sectionId;
		}
	}
			...
			<table class="mainForm">
				...
				<thead>
					<tr align="LEFT" valign="MIDDLE" id="TableTitle">
						<td width="300px" style="padding-left: 7px;"><span>科目内容管理</span>
						</td>
					</tr>
				</thead>
